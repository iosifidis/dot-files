...
#alias
alias up="sudo ucaresystem-core && flatup"
...
alias sistimata="ssh iis21027@colorado.dai.uom.gr"
...
alias updater="sudo apt update && sudo apt upgrade -Vy && sudo apt autoremove -y && sudo apt autoclean && sudo apt clean"
