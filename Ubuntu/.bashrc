...
#alias
alias up="sudo ucaresystem-core && flatup && flatclear && flatclean"
...
alias updater="sudo apt update && sudo apt upgrade -Vy && sudo apt autoremove -y && sudo apt autoclean && sudo apt clean && flatup && flatclear && flatclean"
